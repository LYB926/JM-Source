...
//extern distblk compute_SAD8x8  (imgpel **imgRef, imgpel **imgSrc, int xRef, int xSrc);
//extern distblk compute_SAD4x4  (imgpel **imgRef, imgpel **imgSrc, int xRef, int xSrc);
