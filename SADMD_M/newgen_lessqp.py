...
# QPList   =   ['26', '28', '30', '32', '34', '36', '38', '40']  # --bitrate <integer>     Set bitrate (kbit/s)
QPList   =   [ '28',  '32',  '36',  '40']  # --bitrate <integer>     Set bitrate (kbit/s)
...
# while true; do cp ~/jm_bin/*.log /output/ ; sleep 5; done
# while true; do cp *.log /output/ ; sleep 5; done
