...
distblk compute_SSE_cr(imgpel **imgRef, imgpel **imgSrc, int xRef, int xSrc, int ySize, int xSize)
{
  ...
  for (j = 0; j < ySize; j++)
  {
    ...
    for (i = 0; i < xSize; i++)
      distortion += iabs( *lineRef++ - *lineSrc++ );
  }
 ...
 ***********************************************************************
 */
distblk compute_SAD8x8(imgpel **imgRef, imgpel **imgSrc, int xRef, int xSrc)
{
  int i, j;
  imgpel *lineRef, *lineSrc;
  distblk distortion = 0;
 ...
 ***********************************************************************
 */
distblk compute_SAD4x4(imgpel **imgRef, imgpel **imgSrc, int xRef, int xSrc)
{
  int i, j;
  imgpel *lineRef, *lineSrc;
  distblk distortion = 0;
